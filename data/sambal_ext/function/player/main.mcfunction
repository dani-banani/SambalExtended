...
execute if score @s sambal_ext.custom_weapon.drop_cooldown matches 1 run function sambal_ext:custom_weapon/dir/drop_cooldown_finish
execute if score @s sambal_ext.custom_weapon.swap_cooldown matches 1 run function sambal_ext:custom_weapon/dir/swap_cooldown_finish
## Aniamtions
...
tag @s remove sambal.custom_weapon.entity_hit_player
