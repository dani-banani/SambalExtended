...
execute if score @s sambal_ext.effect.bleed.time matches 20 run function sambal_ext:effects/bleed/damage with storage sambal effect.now.bleed
execute if score @s sambal_ext.effect.bleed.time matches 20.. run scoreboard players set @s sambal_ext.effect.bleed.time 0
