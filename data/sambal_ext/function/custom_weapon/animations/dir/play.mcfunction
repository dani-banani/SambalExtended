...
execute if score @s sambal_ext.custom_weapon.animation_time matches 0 run scoreboard players reset @s sambal_ext.custom_weapon.animation.no_moves_usable